/**
 * @file codes in this file are based on https://github.com/jakearchibald/idb/blob/v2.1.3/lib/idb.js, but modified a little to check whether some db properties exist before proxy methods execute.
 * @author Jake Archibald <jaffathecake@gmail.com>
 * @modified by Sylvia
 */

import dbEnvChecker from './db_env_checker'
